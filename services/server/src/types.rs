...
pub struct Config {
    ...
    /// Optional separate API base for embeddings (falls back to OPENAI_API_BASE)
    pub embedding_api_base: Option<String>,
    /// Embedding model name (default: openai/text-embedding-3-small)
    pub embedding_model: String,
    /// Optional: request specific embedding dimensions (e.g. 1536 for Jina to match pgvector column)
    pub embedding_dimensions: Option<u32>,
    /// LLM model name for fact extraction (default: openai/gpt-4o-mini)
...
impl Config {
    pub fn from_env() -> Self {
        ...
        Self {
            ...
            embedding_dimensions: std::env::var("EMBEDDING_DIMENSIONS").ok()
